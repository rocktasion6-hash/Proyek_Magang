...
<head>
    ...
    <title>Tambah Kenaikan Jabatan</title>
...
<body>
@extends('layouts.hrd')
@section('title', 'Tambah Kenaikan Jabatan')
@section('page_title', 'Tambah Kenaikan Jabatan')
@section('content')
<div class="container">
    ...
    <div class="card">
        ...
        <h1>Tambah Pengajuan Kenaikan Jabatan</h1>
        ...
        <div class="info">
            ...
            Jabatan tujuan harus memiliki
            <strong>level lebih tinggi</strong>
            dibanding jabatan karyawan saat ini.

        </div>

        <form
            method="POST"
            action="{{ route('hrd.kenaikan-jabatan.store') }}"
        >
