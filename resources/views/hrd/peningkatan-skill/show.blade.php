...
<head>
    ...
    <title>Detail Peningkatan Skill</title>
...
<div class="container">
    ...
    <div class="card">
        ...
        <h1>Detail Peningkatan Skill</h1>
        ...
        <div class="row">
            ...
            <div>
                {{ $pengajuan->karyawan->jabatan->nama_jabatan }}
            </div>
            ...
            <div>
                ...
                @php
                    $skillSaatIni = $pengajuan
                        ->karyawan
                        ->skills
                        ->firstWhere('id', $pengajuan->skill_id);

                    $levelSekarang = $skillSaatIni
                        ? $skillSaatIni->pivot->level_skill
                        : 0;
                @endphp
        ...
        <div class="actions">
            ...
            @if(in_array(
                ...
                <form
                    method="POST"
                    action="{{ route(
                        'hrd.peningkatan-skill.approve',
                        $pengajuan
                    ) }}"
                    onsubmit="return confirm(
                        'Yakin ingin menyetujui peningkatan skill ini?'
                    )"
                >
        ...
        <div class="card">
            ...
            >
                ...
                <textarea
                    name="catatan"
                    required
                    placeholder="Contoh: Level skill belum memenuhi kebutuhan."
                ></textarea>
