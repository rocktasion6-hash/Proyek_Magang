...
<div class="container">
    ...
    <div class="header">
        ...
        <div>
            <h1>Peningkatan Skill</h1>

            <p>
                Manajemen proses peningkatan skill karyawan.
            </p>
        </div>

        <a
            href="{{ route('hrd.peningkatan-skill.create') }}"
    ...
    <table>
        ...
        @empty
            ...
            <tr>
                ...
                >
                    Belum ada pengajuan peningkatan skill.
                </td>
