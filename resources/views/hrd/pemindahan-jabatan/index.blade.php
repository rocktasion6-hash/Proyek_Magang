...
<head>
    ...
    <title>Pemindahan Jabatan</title>
...
<body>
@extends('layouts.hrd')
@section('title', 'Pemindahan Jabatan')
@section('page_title', 'Pemindahan Jabatan')
@section('content')
<div class="container">
    ...
    <div class="header">
        ...
        <div>
            <h1>Pemindahan Jabatan</h1>

            <p>
                Manajemen proses pemindahan jabatan karyawan.
            </p>
        </div>

        <a
            href="{{ route('hrd.pemindahan-jabatan.create') }}"
    ...
    <table>
        ...
        @empty
            ...
            <tr>
                ...
                >
                    Belum ada pengajuan pemindahan jabatan.
                </td>
            </tr>
