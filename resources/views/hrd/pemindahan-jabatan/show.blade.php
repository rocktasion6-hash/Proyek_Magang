...
<head>
    ...
    <title>Detail Pemindahan Jabatan</title>
...
<body>
@extends('layouts.hrd')
@section('title', 'Detail Pemindahan Jabatan')
@section('page_title', 'Detail Pemindahan Jabatan')
@section('content')
<div class="container">
    ...
    <div class="card">
        ...
        <h1>Detail Pemindahan Jabatan</h1>
        ...
        <div class="row">
            ...
            <div>
                {{ ucfirst($pengajuan->hasilAssessment->status) }}
            </div>
        ...
        <div class="actions">
            ...
            @if($pengajuan->status === 'diajukan')
                ...
                <form
                    method="POST"
                    action="{{ route(
                        'hrd.pemindahan-jabatan.process',
                        $pengajuan
                    ) }}"
                >
            ...
            @if(in_array($pengajuan->status, ['diajukan', 'diproses']))
                ...
                <form
                    method="POST"
                    action="{{ route(
                        'hrd.pemindahan-jabatan.approve',
                        $pengajuan
                    ) }}"
                    onsubmit="return confirm(
                        'Yakin ingin menyetujui pemindahan jabatan ini?'
                    )"
                >
